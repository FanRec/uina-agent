import type { SessionNodeInfo, SessionRecord } from "../../../src/session/types.js";
 ...
 */
export function assertDAGInvariants(records: readonly (SessionRecord | SessionNodeInfo)[]): void {
